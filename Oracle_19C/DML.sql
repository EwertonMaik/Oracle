...
INSERT INTO departments VALUES (301, 'Inovation', NULL, NULL);

-- Inserindo Linhas com valores NULOS – Método Implícito
INSERT INTO departments(department_id, department_name) VALUES (302, 'IOT');
...
-- Ao ser executado, é exibido prompot de entrada de dados para as variáveis
...
SAVEPOINT A; -- Definindo um ponto de salvamento para os commit's

INSERT INTO employees (employee_id, first_name, last_name, email, phone_number, hire_date, job_id, salary,
            commission_pct, manager_id, department_id)
       VALUES (208, 'Vito', 'Corleone', 'VCORL', '525.342.237', TO_DATE('11/02/2020', 'DD/MM/YYYY'), 'IT_PROG', 20000, NULL, 103, 60);
               
ROLlBACK TO SAVEPOINT  A; -- Aplicando um rollback no ponto de salvamento A
COMMIT; 

SELECT * FROM employees ORDER BY employee_id DESC;

-- Cláusula FOR UPDATE no comando SELECT
-- Utilizada para deixar a linha do dado consultado em LOCK
