-- Indices
-- Objeto independente de uma tabela que indexa os registros de uma tabela
-- Tornando a busca e performace (I/O) da linhas com melhor desempenho para o banco de dados
-- É criado automaticamente ao definir uma PRIMARY KEY ou UNIQUE em uma tabela
