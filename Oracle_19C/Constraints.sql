...
-- NOT NULL -- Impede que o campo receba valores Nulos
-- UNIQUE   -- Impede que o campo recebe valores Duplicados, apenas únicos
-- PRIMARY KEY -- Torna a coluna um conjunto de valores únivos e primários, chaves de identificação de cada linha
-- FOREIGN KEY -- Torna a os registros da coluna, uma referência a outra coluna de uma tabela, chave estrangeira
-- CHECK -- Faz uma verificação no campo, uma validação
...
CREATE TABLE projects (
 ...
 CREATION_DATE DATE         DEFAULT sysdate NOT NULL, -- Recebe sempre a Data Atual pela Função SYSDATE
 START_DATE    DATE,
 END_DATE      DATE,
...
CREATE TABLE projects (
 project_id    NUMBER(6)    NOT NULL CONSTRAINT projects_project_id_pk PRIMARY KEY, -- Definindo CONSTRAINT
 project_code  VARCHAR2(10) NOT NULL,
 project_name  VARCHAR2(100)NOT NULL,
 department_id NUMBER(4)    NOT NULL,
...
CREATE TABLE projects (
 project_id    NUMBER(6)    NOT NULL CONSTRAINT projects_project_id_pk PRIMARY KEY, -- Chave Primaria
 project_code  VARCHAR2(10) NOT NULL CONSTRAINT projects_project_code_uk UNIQUE, -- Único
 project_name  VARCHAR2(100)NOT NULL,
 department_id NUMBER(4)    NOT NULL,
 CREATION_DATE DATE         DEFAULT sysdate NOT NULL,
 START_DATE    DATE,
...
CREATE TABLE projects (
 ...
 STATUS        VARCHAR2(20) NOT NULL,
 PRIORITY      VARCHAR2(10) NOT NULL,
 BUDGET        NUMBER(11,2) NOT NULL CONSTRAINT projects_budget_ck CHECK (budget > 0), -- Campo tem que ser maior que 0
 DESCRIPTION   VARCHAR2(400)NOT NULL
);
 --***********************************************************************************************
...
(project_id    NUMBER(6)    NOT NULL, 
 ...
 INSERT INTO projects (
    project_id, project_code, project_name, department_id, creation_date, start_date, end_date, status, priority,
    budget, description) 
    VALUES (1, 'ERPIMP', 'ERP Implementation', 77, sysdate, null, null, 'Aproved', 'HIGH',
...
INSERT INTO projects (
    ...
    budget, description) 
    VALUES (1, 'ERPIMP', 'ERP Implementation', 60, sysdate, null, null, 'Aproved', 'HIGH',
    1000000.00, 'Oracle ERP Implementation');
