...
1 - IN (Igual a qualqer membro da lista)
2 - ANY (Compara um valor para qualqer valor na lista retornada pela Sub-Consulta)
3 - ALL (Compara um valor para todos os valores na lista retornada pela Sub-Consulta)
