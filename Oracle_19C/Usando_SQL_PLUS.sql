-- Utilizando os recursos do SQL PLUS nativo do ORACLE
...
-- Direcionando a sa host da execução do comando para um arquivo SPOOL
...
-- Utilizando o Comando ACCEPT -- Inserção de Valor a uma Variável
